...
export const REWARDS = /** @type {Reward[]} */ ([
  { id: 'free-fries',   name: 'Free Fries',    desc: 'Any regular size',    cost: 500,  art: 'assets/items/fries.png',      tier: 1 },
  { id: 'big-mac',      name: 'Big Mac',       desc: 'The signature stack', cost: 1000, art: 'assets/items/bigmac.png',     tier: 2 },
  { id: 'nuggets-6pc',  name: '6pc Nuggs',     desc: 'Chicken McNuggets',   cost: 2500, art: 'assets/items/nuggets.png',    tier: 3 },
  { id: 'apple-pie',    name: 'Pie Me',        desc: 'Baked apple pie',     cost: 5000, art: 'assets/items/applepie.png',   tier: 4 },
  { id: 'mcflurry',     name: 'McFlurry',      desc: 'Swirled + topped',    cost: 7500, art: 'assets/items/mcflurry.png',   tier: 5 },
  { id: 'hash-brown',   name: 'Hash Brown',    desc: 'Crispy, golden',      cost: 300,  art: 'assets/items/hashbrown.png',  tier: 1 },
]);
