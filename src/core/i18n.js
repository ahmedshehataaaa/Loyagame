...
const STRINGS = {
  en: {
    ...
    'signin.unverified': 'Your number is not verified by SMS.',
    ...
    'reward.unavailable.msg':
      'Rewards are not available in this build. Your score still counts locally.',
  ...
  ar: {
    ...
    'signin.unverified': 'رقمك غير مُوثّق برسالة نصية.',
    ...
    'reward.unavailable.msg': 'الجوائز غير متاحة في هذه النسخة. نتيجتك محفوظة محلياً.',
