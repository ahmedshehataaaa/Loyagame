...
const STRINGS = {
  en: {
    ...
    'welcome.title': 'Welcome to<br>McSlice Rush!',
    'welcome.titleBrand': 'Welcome to<br>{game}!',
    'welcome.sub': 'Slice your way to real rewards',
    ...
    'welcome.prizeTeaserRange': 'Prizes from {from} to {to}',
    ...
    'howTo.avoidBrand': 'Never slice the hazard. {lives} of them ends your round.',
    ...
    'signin.legal': 'By continuing, you agree to our {terms} and {privacy}.',
    'signin.legalTerms': 'Terms of Service',
    'signin.legalPrivacy': 'Privacy Policy',
    ...
    'play.hintBrand': 'Swipe across the food to slice it — avoid the hazards!',
    'wheel.off': 'OFF',
    'wheel.free': 'FREE',
    ...
    'lb.seasonEnds': 'Season ends in',
    'lb.reset': 'Month-end reset',
    'lb.thisSeason': 'This season',
    'lb.youRank': 'You: #{rank}',
    'lb.live': 'LIVE',
    'lb.pts': 'PTS',
    'lb.loading': 'Loading standings…',
    'lb.play': 'Play a round',
    'lb.none': 'No standings yet',
    'lb.noneBody': 'Play a round to put yourself on the board.',
    'lb.firstScore': 'Play a round to set your first score.',
    'lb.unavailable': 'Standings unavailable',
    'lb.unavailableBody': 'Could not load the board. Try again shortly.',
    'lb.tier1': 'Ultimate Master',
    'lb.tier2': 'Diamond Rank',
    'lb.tier3': 'Platinum Rank',
    'lb.tier4': 'Gold Rank',
    'lb.tier5': 'Ranked Player',
  ...
  ar: {
    ...
    'welcome.title': 'أهلاً في<br>ماك سلايس راش!',
    'welcome.titleBrand': 'أهلاً في<br>{game}!',
    'welcome.sub': 'اشرح طريقك نحو جوائز حقيقية',
    ...
    'welcome.prizeTeaserRange': 'جوائز من {from} إلى {to}',
    'welcome.prizeTeaserOne': 'اربح {prize}',
    'welcome.prizeTeaserBrand': 'العب واكسب جوائز حقيقية من {brand}',
    'tenant.unavailableTitle': 'هذه اللعبة غير متاحة الآن',
    'tenant.unavailableBody': 'ربما انتهت الحملة أو تم إيقافها مؤقتاً. يرجى سؤال أحد الموظفين.',
    'tenant.previewBar': 'معاينة — الجوائز متوقفة',
    ...
    'howTo.avoidBrand': 'لا تقطع العنصر الممنوع أبداً. {lives} منها تنهي دورك.',
    ...
    'signin.legal': 'بالمتابعة، أنت توافق على {terms} و{privacy}.',
    'signin.legalTerms': 'شروط الخدمة',
    'signin.legalPrivacy': 'سياسة الخصوصية',
    ...
    'play.hintBrand': 'اسحب على الطعام لتقطيعه — وتجنّب العناصر الممنوعة!',
    'wheel.off': 'خصم',
    'wheel.free': 'مجاناً',
    ...
    'result.lostSub': 'قطعت {lives} من الدفعات المحروقة.',
    ...
    'reward.eliminated.msg': 'قطعت الكثير من الدفعات المحروقة. اصمد الدور كاملاً لتدخل السحب.',
    ...
    'terms.rulesB':
      'الدور {seconds} ثانية. تقطيع {lives} من الدفعات المحروقة ينهيه. تفوز بالصمود الدور كاملاً.',
    ...
    'lb.seasonEnds': 'ينتهي الموسم خلال',
    'lb.reset': 'يُعاد الضبط نهاية الشهر',
    'lb.thisSeason': 'هذا الموسم',
    'lb.youRank': 'أنت: #{rank}',
    'lb.live': 'مباشر',
    'lb.pts': 'نقطة',
    'lb.loading': 'جارٍ تحميل الترتيب…',
    'lb.play': 'العب دوراً',
    'lb.none': 'لا ترتيب بعد',
    'lb.noneBody': 'العب دوراً لتظهر على اللوحة.',
    'lb.firstScore': 'العب دوراً لتسجّل أول نتيجة لك.',
    'lb.unavailable': 'الترتيب غير متاح',
    'lb.unavailableBody': 'تعذّر تحميل اللوحة. حاول مجدداً بعد قليل.',
    'lb.tier1': 'البطل الأعلى',
    'lb.tier2': 'مرتبة الماس',
    'lb.tier3': 'مرتبة البلاتين',
    'lb.tier4': 'المرتبة الذهبية',
    'lb.tier5': 'لاعب مصنّف',
